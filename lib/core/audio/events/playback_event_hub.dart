...
class PlaybackEventHub {
  ...
  late final Stream<PlaybackClearedEvent> playbackCleared =
      _eventSubject.whereType<PlaybackClearedEvent>();

  late final Stream<PlaybackCompletedEvent> playbackCompleted =
      _eventSubject.whereType<PlaybackCompletedEvent>();
