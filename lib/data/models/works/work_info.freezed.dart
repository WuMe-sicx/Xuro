...
mixin _$WorkInfo {
  ...
  double? get rateAverage2dp => throw _privateConstructorUsedError;
  @JsonKey(name: 'rate_count_detail')
  List<RateDetail>? get rateCountDetail => throw _privateConstructorUsedError;
  List<RankInfo>? get rank => throw _privateConstructorUsedError;
  ...
  List<WorkVA>? get vas => throw _privateConstructorUsedError;
  List<WorkTag>? get tags => throw _privateConstructorUsedError;
...
abstract class $WorkInfoCopyWith<$Res> {
  factory $WorkInfoCopyWith(WorkInfo value, $Res Function(WorkInfo) then) =
      _$WorkInfoCopyWithImpl<$Res, WorkInfo>;
  @useResult
  $Res call(
      {int? id,
      String? title,
...
/// @nodoc
class _$WorkInfoCopyWithImpl<$Res, $Val extends WorkInfo>
...
/// @nodoc
abstract class _$$WorkInfoImplCopyWith<$Res>
    implements $WorkInfoCopyWith<$Res> {
  factory _$$WorkInfoImplCopyWith(
          _$WorkInfoImpl value, $Res Function(_$WorkInfoImpl) then) =
      __$$WorkInfoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$WorkInfoImplCopyWithImpl<$Res>
    extends _$WorkInfoCopyWithImpl<$Res, _$WorkInfoImpl>
    implements _$$WorkInfoImplCopyWith<$Res> {
  __$$WorkInfoImplCopyWithImpl(
      _$WorkInfoImpl _value, $Res Function(_$WorkInfoImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$WorkInfoImpl implements _WorkInfo {
  _$WorkInfoImpl(
      {this.id,
      this.title,
  ...
  factory _$WorkInfoImpl.fromJson(Map<String, dynamic> json) =>
      _$$WorkInfoImplFromJson(json);
  ...
  final List<RateDetail>? _rateCountDetail;
  @override
  @JsonKey(name: 'rate_count_detail')
  List<RateDetail>? get rateCountDetail {
  ...
  final List<RankInfo>? _rank;
  @override
  List<RankInfo>? get rank {
    final value = _rank;
    if (value == null) return null;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._rank, _rank) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(_rank),
        hasSubtitle,
        createDate,
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$WorkInfoImplCopyWith<_$WorkInfoImpl> get copyWith =>
      __$$WorkInfoImplCopyWithImpl<_$WorkInfoImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$WorkInfoImplToJson(
      this,
    );
  }
}
...
abstract class _WorkInfo implements WorkInfo {
  factory _WorkInfo(
      ...
      @JsonKey(name: 'rate_average_2dp') final double? rateAverage2dp,
      @JsonKey(name: 'rate_count_detail')
      final List<RateDetail>? rateCountDetail,
      final List<RankInfo>? rank,
      ...
      final String? samCoverUrl,
      final String? thumbnailCoverUrl,
      final String? mainCoverUrl}) = _$WorkInfoImpl;

  factory _WorkInfo.fromJson(Map<String, dynamic> json) =
      _$WorkInfoImpl.fromJson;
